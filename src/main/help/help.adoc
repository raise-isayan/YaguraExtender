...
Language/link:help-ja.html[日本語]
...
image:images/custom_sendto_server_setting.png[Edit SendToItem SendTo Settings Dialog]
...
CAUTION: SOCKS Proxy does not work due to a JDK bug
